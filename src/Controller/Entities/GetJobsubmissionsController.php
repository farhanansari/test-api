...
/* * ************************************************************************************
 * Class name      : GetJobsubmissions Controller
 * Description     : Fetch applicants for a job order
...
class GetJobsubmissionsController extends AppController {
    ...
    /*     * * * * * * * * *  * * * *    
     * Action Name   : index
     * Description   : To get job submission details for a specific job order.
     * Created by    : Sivaraj V
     * Updated by    : Sivaraj V
     * Created Date  : 01-09-2016
     * Updated Date  : 02-09-2016
     * URL           : /entities/get_jobsubmissions/?
    ...
    public function index($params = null){
        ...
        $url = $_SESSION['BH']['restURL'] . '/entity/JobOrder/' . $params['id'] . '?BhRestToken=' . $_SESSION['BH']['restToken'] . '&fields=submissions';
