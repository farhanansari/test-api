    ...
    <body style="background:#f6f6f6 ">
        <table width="600" cellpadding="0" cellspacing="0" align="center" >
            <tbody>
                <tr>
                 <?php 
                  echo $this->element('PCEmail/header',['subject' => 'New Registration Request']);
                  ?>
                </tr>
           <tr>
				...
				<p style="padding:0px; margin:0px; color:#000000; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:14px; ">A new registration request has been received. Please click below to view the registration request:</p>
				</td>
			</tr>
			<tr>
			<td>
		...
		<tr> 
			...
			<p style="padding:0px; margin:0px; color:#000000; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:14px; ">Please follow-up with the user after taking the necessary steps to confirm the validity of the request.</p>
			</td>
		</tr>
		<tr>
                    <?php 
