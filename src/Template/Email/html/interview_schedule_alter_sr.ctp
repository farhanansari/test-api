        ...
        <table width="600" cellpadding="0" cellspacing="0" align="center" >
                ...
                <tr>
                    <td style="padding:7px 0px 12px;" >
                        <h6 style="padding:0px 0px 14px; margin:0px; color:#3054ba; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:16px; font-weight:bold;">
                            <?= $var['title']; ?></h6>
                        <p style="padding:0px; margin:0px; color:#000000; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:14px; "><?= $var['schedule_data']['message']; ?></p>
                    </td>
                </tr>
                <tr>
			...
			<table width="100%">
				...
				<p style="color:#000; font-size:14px; padding:0px; margin:0px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-weight:normal;">
                                    <span style="color:#2f5496;">Job ID #</span> <?php echo $jobID = isset($var['schedule_data']['joborder_id']) ? $var['schedule_data']['joborder_id']: 'NIL' ;?>
                                </p>
				</td>
				...
				<p style="color:#000; font-size:14px;  padding:0px; margin:0px;  font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-weight:normal;">
                                    <span style="color:#2f5496;">Job Title #</span> <?php echo $jobTitle = isset($var['schedule_data']['joborder_title']) ? $var['schedule_data']['joborder_title'] : 'NIL' ;?>
                                </p>
				</td>
				</tr>
				</tbody>
                            ...
                            <tbody>
                                <tr>
                                    <td align="left" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 16px; margin: 0;  padding:4px 0px 10px; ">
                                        ...
                                        <a href="<?= $var['verifyLink']; ?>" style="border-radius: 6px; font-size:14px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;  background-color:#4472c4; padding:6px 45px; border:1px solid #2d4570; color:#000; cursor:pointer; outline:none; font-weight:bold;text-decoration: none;">View Contractor Profile</a>
                                        <?php } ?>
                                    </td>
                                </tr>
                            </tbody>
