    ...
    <body style="background:#f6f6f6 ">
        <table width="600" cellpadding="0" cellspacing="0" align="center" >
            <tbody>
                <tr>
				<?php 
                  echo $this->element('PCEmail/header',['subject' => 'Contact Form']);
                  ?>
                </tr>
               		<tr>
			...
			Hello,</h6>
			<p style="padding:0px; margin:0px; color:#000000; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:14px; ">Please check below details!</p>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<span style="color:#2f5496;">Name: </span><?= $var['name']; ?></h5>
			<h5 style="color:#000; font-size:14px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; padding:0px 0px 13px; margin:0px;  font-weight:normal;">
			<span style="color:#2f5496;">Email: </span>	<?= $var['email']; ?></h5>
			<h5 style="color:#000; font-size:14px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; padding:0px 0px 13px; margin:0px;  font-weight:normal;">
			<span style="color:#2f5496;">Phone: </span>	<?= $var['phone']; ?></h5>
			<h5 style="color:#000; font-size:14px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; padding:0px 0px 13px; margin:0px;  font-weight:normal;">
            <span style="color:#2f5496;">Message: </span> <?= $var['message']; ?></h5>
			<p style="color:#666666; font-size:12px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; padding:0px 0px 12px; margin:0px;  font-weight:normal;">Note: This mail was sent from <?= $var['contact_via']; ?></p>
			</td>
		</tr>
		<tr>
					<?php 
