        ...
        <table width="600" cellpadding="0" cellspacing="0" align="center" >
			...
			<table width="100%">
				...
				<p style="color:#000; font-size:14px; padding:0px; margin:0px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-weight:normal;">
                                    <span style="color:#2f5496;">Job ID #</span> <?php echo $placementID = isset($var['rating_data']['joborder_id']) ? $var['rating_data']['joborder_id']: 'NIL' ;?>
                                </p>
				</td>
				...
				<p style="color:#000; font-size:14px;  padding:0px; margin:0px;  font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-weight:normal;text-align: right;">
                                    <span style="color:#2f5496;">Job Title #</span> <?php echo $jobTitle = isset($var['rating_data']['joborder_title']) ? $var['rating_data']['joborder_title'] : 'NIL' ;?>
                                </p>
				</td>
				</tr>
                                <tr>
				<td align="left" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 16px; margin: 0; padding:10px 0px 10px; ">
				<p style="color:#000; font-size:14px; padding:0px; margin:0px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-weight:normal;">
                                    <span style="color:#2f5496;">Contractor #</span> <?php echo $contractor = isset($var['rating_data']['placement_contractor_fname']) ? $var['rating_data']['placement_contractor_fname']." ". $var['rating_data']['placement_contractor_lname']: 'NIL' ;?>
                                </p>
				</td>
				</tr>    
				</tbody>
                            ...
                            <tbody>
                                <tr>
                                    <td align="left" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 16px; margin: 0;  padding:4px 0px 10px; ">
                                        ...
                                        <a href="<?= $var['verifyLink']; ?>" style="border-radius: 6px; font-size:14px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;  background-color:#4472c4; padding:6px 45px; border:1px solid #2d4570; color:#000; cursor:pointer; outline:none; font-weight:bold;text-decoration: none;">View Assignment</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <tr>
                    <td style="padding:7px 0px 30px;">
                        <h5 style="color:#000; font-size:14px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; padding:0px 0px 13px; margin:0px;  font-weight:normal;">
                            <b>
                            <?php if(isset($var['statusFlag']) && ($var['statusFlag'] == 5) ) {
                            echo 'Please follow-up with the hiring manager, as the performance rating is required before the contractor can be paid.';
                            } else {
                            echo 'Please escalate to the client’s account manager.';
                            }
                            ?>
                            </b>
                        </h5>
