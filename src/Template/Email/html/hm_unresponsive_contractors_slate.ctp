    ...
    <body style="background:#f6f6f6 ">
        <table width="600" cellpadding="0" cellspacing="0" align="center" >
            <tbody>
                <tr>
				<?php 
                  echo $this->element('PCEmail/header',['subject' => 'Recomendations Reminder']);
                  ?>
                </tr>
           <tr>
				...
				<?= $var['title']; ?></h6>
					<p style="padding:0px; margin:0px; color:#000000; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:14px; ">Contractors are anxious to hear from you!</p>
				</td>
			</tr>
	    <tr>
		...
		<tr>
			...
			<table width="100%">
				...
				<span style="color:#2f5496;">Job ID #</span> <?php echo $jobID = isset($var['joborder_id']) ? $var['joborder_id']: 'NIL' ;?></p>
				</td>
				...
				<p style="color:#000; font-size:14px;  padding:0px; margin:0px;  font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-weight:normal;text-align: right;">
                                <span style="color:#2f5496;">Job Title #</span> <?php echo $jobTitle = isset($var['jobTitle']) ? $var['jobTitle'] : 'NIL' ;?></p>
				</td>
				</tr>
				</tbody>
			</table>
			...
			<table width="100%">
				...
				<tr>
					...
					<a href="<?php echo WEB_SERVER_ADDR; ?>" target="_blank" style="border-radius: 6px; font-size:14px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;  background-color:#4472c4; padding:6px 45px; border:1px solid #2d4570; color:#000; cursor:pointer; outline:none; font-weight:bold;" >View Contractor Profiles</a>
					</td>
				</tr>
				</tbody>
			</table>
		...
		<tr> 
			...
			<p style="padding:0px; margin:0px; color:#000000; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:14px; ">Please review the profiles of the recommended contractors and determine next steps.</p>
			</td>
		</tr>
		<tr> 
			<td style="padding:10px 0px 0px;">
			<p style="padding:0px; margin:0px; color:#000000; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:14px; ">The best contractors get hired quickly.  Don’t miss out!</p>
			</td>
		</tr>
		<tr> 
			<td style="padding:10px 0px 0px;">
			<p style="padding:0px; margin:0px; color:#000000; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:14px; ">We are here to assist if you need us.</p>
			</td>
		</tr>
		<tr>
			<?php 
