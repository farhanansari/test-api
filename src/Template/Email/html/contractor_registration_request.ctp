...
<html xmlns="http://www.w3.org/1999/xhtml" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
    ...
    <body style="background:#f6f6f6 ">
		...
		<tr> 
			...
			<p style="padding:0px; margin:0px; color:#000000; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:14px; ">Once you have validated your email address (required), your PeopleCaddie account will be activated.</p>
			</td>
		</tr>
		<tr>
                    <?php 
