        ...
        <table width="600" cellpadding="0" cellspacing="0" align="center" >
           ...
           <tr>
				...
				Hello <?= $var['firstName']; ?> <?= $var['lastName']; ?>,</h6>
					<p style="padding:0px; margin:0px; color:#000000; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:14px; ">Your password has been updated <?= $var['updatedBy']; ?> If you did not request to have your password updated, please contact PeopleCaddie immediately.</p>
				</td>
		</tr>
		<tr>
			<td>
			<table width="100%">
				...
				<span style="color:#2f5496;">New Password:</span> <?= $var['password']; ?></p>
				</td>
