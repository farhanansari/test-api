                        ...
                        <table width="100%">
                            <tbody>
                                <tr>
                                 ...
                                 <?php echo $jobId = isset($var['jobId']) ? $var['jobId']: 'NIL' ;?></p>
                                    </td>
                            ...
                            <tbody>
                                <tr>
                                    <td align="left" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 16px; margin: 0;  padding:4px 0px 10px; ">
                                        <a href="<?= $var['candidateLink']; ?>" style="border-radius: 6px; font-size:14px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;  background-color:#4472c4; padding:6px 45px; border:1px solid #2d4570; color:#000; cursor:pointer; outline:none; font-weight:bold;text-decoration: none;">View Profile</a>
                                    </td>
                    ...
                    <td style="padding:7px 0px 30px;">
                        ...
                        if(!empty($phoneNo)) {
                            ...
                            if(!empty($var['intw_data']['placement_contractor_skype'])) { ?>
                                ...
                                Please contact the contractor at <?php 
                            ...
                            Please contact the contractor at <b>[Contractor did not updated his/her SkypeID]</b>  
                            <?php 
                            }
                            
                        } else {
                            ?>
                            Please meet the contractor at 
                            <?php 
