    ...
    <body style="background:#f6f6f6 ">
        <table width="600" cellpadding="0" cellspacing="0" align="center" >
			...
			<table width="100%">
				...
				<td align="left" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 16px; margin: 0; padding:10px 0px 10px; ">
				<p style="color:#000; font-size:14px; padding:0px; margin:0px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-weight:normal;">
                                    <span style="color:#2f5496;">Employer #</span> <?php echo $employer = isset($var['employer']) ? $var['employer'] : 'NIL' ;?>
                                </p>
				</td>
                                <td align="right" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 16px; margin: 0;  padding:10px 0px 10px; ">
				<p style="color:#000; font-size:14px;  padding:0px; margin:0px;  font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-weight:normal;text-align: right;">
				...
				<p style="color:#000; font-size:14px; padding:0px; margin:0px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-weight:normal;">
                                    ...
                                    <?php if(isset($var['candidate_bid_value']) && !empty($var['candidate_bid_value'])) {
                                        echo '$ '. $var['candidate_bid_value'].' / hour';
                                    }
                                   ?>     
                                </p>
				</td>
                            ...
                            <tbody>
                                <tr>
                                    <td align="left" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 16px; margin: 0;  padding:4px 0px 10px; ">
                                        ...
                                        <a href="<?= $var['verifyLink']; ?>" style="border-radius: 6px; font-size:14px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;  background-color:#4472c4; padding:6px 45px; border:1px solid #2d4570; color:#000; cursor:pointer; outline:none; font-weight:bold;text-decoration: none;">
                                        <?php echo (($var['statusFlag'] == 6) || ($var['statusFlag'] == 7)) ? 'Please log in to your mobile app for additional information' : 'View Position'; ?></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <tr>
                    <td style="padding:7px 0px 30px;">
                        <h5 style="color:#000; font-size:14px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; padding:0px 0px 13px; margin:0px;  font-weight:normal;">
                            <?php if(isset($var['statusFlag']) && ($var['statusFlag'] == 7)) { 
                                echo '<span style="color:red;font-weight: bold;">You must click accept before the assignment is final.</span>'
                                . '  If you are unable to accept this position for any reason, please contact us at '.$var['phone_no']; 
                            } else if(isset($var['statusFlag']) && ($var['statusFlag'] == 6)) {
                                echo 'If you are unable to accept this position for any reason, please contact us at '.$var['phone_no'];
                            } else if(isset($var['statusFlag']) && ($var['statusFlag'] == 8)) {
                                echo 'Please follow-up as required.';
                            } ?>
                        </h5>
