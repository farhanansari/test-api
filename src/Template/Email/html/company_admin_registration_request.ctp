    ...
    <body style="background:#f6f6f6 ">
        <table width="600" cellpadding="0" cellspacing="0" align="center" >
            <tbody>
                <tr>
                  <?php 
                  echo $this->element('PCEmail/header',['subject' => 'Registration Request Received']);
                  ?>
                </tr>
           <tr>
				...
				Hello <?= $var['firstName']; ?> <?= $var['lastName']; ?>,</h6>
					<p style="padding:0px; margin:0px; color:#000000; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:14px; ">We have received your registration request. Please click below to validate your email address:</p>
				</td>
			</tr>
			<tr>
			<td>
			<table width="100%">
				...
				<tr>
					...
					<a href="<?= $var['verifyLink']; ?>" target="_blank" style="border-radius: 6px; font-size:14px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;  background-color:#4472c4; padding:6px 45px; border:1px solid #2d4570; color:#000; cursor:pointer; outline:none; font-weight:bold;text-decoration: none;" >Validate Email Address</a>
					</td>
				</tr>
				<tr>
		...
		<tr> 
			...
			<p style="padding:0px; margin:0px; color:#000000; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:14px; ">Once you have validated your email address (required), a PeopleCaddie representative will contact you shortly to follow up.</p>
			</td>
		</tr>
		<tr>
                    <?php 
