    ...
    <body style="background:#f6f6f6 ">
        <table width="600" cellpadding="0" cellspacing="0" align="center" >
            <tbody>
                <tr>
                 <?php 
                  echo $this->element('PCEmail/header',['subject' => 'Profile Updated']);
                  ?>
                </tr>
           <tr>
				...
				Hello <?= $var['firstName']; ?> <?= $var['lastName']; ?>,</h6>
					<p style="padding:0px; margin:0px; color:#000000; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:14px; ">Your profile has been updated. If you did not request to have your profile updated, please contact PeopleCaddie immediately.</p>
				</td>
		</tr>
		<tr> 
