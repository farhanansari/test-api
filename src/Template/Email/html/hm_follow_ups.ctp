    ...
    <body style="background:#f6f6f6 ">
        <table width="600" cellpadding="0" cellspacing="0" align="center" >
            <tbody>
                <tr>
				 <?php 
                  echo $this->element('PCEmail/header',['subject' => 'HM Email Not Validated']);
                  ?>
                </tr>
           <tr>
				...
				<?= $var['title']; ?></h6>
					<p style="padding:0px; margin:0px; color:#000000; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:14px; ">A new registration request has been received, but the hiring manager has not validated her/his email address. Please click below to view the registration request and determine appropriate next steps:</p>
				</td>
			</tr>
			<tr>
			<td>
