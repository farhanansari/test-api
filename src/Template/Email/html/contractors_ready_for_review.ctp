    ...
    <body style="background:#f6f6f6 ">
        <table width="600" cellpadding="0" cellspacing="0" align="center" >
            <tbody>
                <tr>
				<?php 
                  echo $this->element('PCEmail/header',['subject' => 'Recomendations Notification']);
                  ?>
                </tr>
           <tr>
				...
				<?= $var['title']; ?></h6>
					<p style="padding:0px; margin:0px; color:#000000; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:14px; ">PeopleCaddie's top contractor recommendations are ready for review!</p>
				</td>
			</tr>
	    <tr>
		...
		<tr>
			...
			<table width="100%">
				...
				<tr>
					...
					<a href="<?php echo $var['link']; ?>" target="_blank" style="border-radius: 6px; font-size:14px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;  background-color:#4472c4; padding:6px 45px; border:1px solid #2d4570; color:#000; cursor:pointer; outline:none; font-weight:bold;" >View Contractor Profiles</a>
					</td>
				</tr>
				</tbody>
			</table>
		...
		<tr> 
			<td style="padding:10px 0px 0px;">
			<p style="padding:0px; margin:0px; color:#000000; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:14px; ">The best contractors are the first to get hired.  Don’t miss out!</p>
			</td>
		</tr>
		<tr> 
			<td style="padding:10px 0px 0px;">
