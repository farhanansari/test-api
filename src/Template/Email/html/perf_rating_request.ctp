        ...
        <table width="600" cellpadding="0" cellspacing="0" align="center" >
			...
			<table width="100%">
				...
				<p style="color:#000; font-size:14px; padding:0px; margin:0px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-weight:normal;">
                                    <span style="color:#2f5496;">Job ID #</span> <?php echo $placementID = isset($var['placementID']) ? $var['placementID']: 'NIL' ;?>
                                </p>
				</td>
				...
				<td align="left" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 16px; margin: 0; padding:10px 0px 10px; ">
				<p style="color:#000; font-size:14px; padding:0px; margin:0px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-weight:normal;">
                                    <span style="color:#2f5496;">Contractor: </span>
                                    <?php
                            ...
                            <tbody>
                                <tr>
                                    <td align="left" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-size: 16px; margin: 0;  padding:4px 0px 10px; ">
                                        <a href="<?= $var['verifyLink']; ?>" style="border-radius: 6px; font-size:14px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;  background-color:#4472c4; padding:6px 45px; border:1px solid #2d4570; color:#000; cursor:pointer; outline:none; font-weight:bold;text-decoration: none;">Submit Performance Rating</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <tr>
                    <td style="padding:7px 0px 30px;">
                        <h5 style="color:#000; font-size:14px; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; padding:0px 0px 13px; margin:0px;">
                            <?php
                                $bottomText = (isset($var['statusFlag'])) ? $var['statusFlag'] : "";
                                switch ($bottomText) {
                                    case 0 :
                                        $message = "<p style='font-weight:normal;'>Your performance rating is required before the contractor can be paid.</p>";
                                        break;
                                    case 1 :
                                        $message = "<p style='font-weight:bold;'>Your performance rating is required before the contractor can be paid.</p>" ;
                                        break;
                                    case 2 :
                                        $message = "<p style='font-weight:bold;color:red;'>Your performance rating is required before the contractor can be paid.</p>";
                                        break;
                                }
                                echo $message;
                            ?>
